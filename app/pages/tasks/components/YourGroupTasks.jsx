                                ...
                                <div className="govuk-grid-column-one-third govuk-!-margin-bottom-3">
                                    {
                                        ...
                                        task.assignee === null ? <span
                                                className="govuk-!-font-size-19 govuk-!-font-weight-bold">Unassigned</span>
                                            : (task.assignee === userId ?
                                            <span className="govuk-!-font-size-19 govuk-!-font-weight-bold">Assigned to you</span>
                                            : <span
                                                className="govuk-!-font-size-19 govuk-!-font-weight-bold">{task.assignee}</span>)
                                    }
