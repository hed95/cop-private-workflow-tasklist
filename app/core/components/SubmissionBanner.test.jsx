...
describe('SubmissionBanner', () => {
  ...
  it('renders submission if data received', () => {
    const expectedHtml =
      '<div class="container" id="successfulSubmission" style="padding-top:5px"><div class="govuk-panel govuk-panel--confirmation"><div class="govuk-panel__body govuk-!-font-size-24 govuk-!-font-weight-bold">test</div></div></div>';
    const wrapper = shallow(<SubmissionBanner />);
